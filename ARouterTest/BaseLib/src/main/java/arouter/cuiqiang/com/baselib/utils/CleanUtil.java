...
public class CleanUtil {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(LingContext.getApplicatonContext().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(LingContext.getApplicatonContext().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(new File(LingContext.getApplicatonContext().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return LingContext.getApplicatonContext().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSp() {
        return deleteFilesInDir(new File(LingContext.getApplicatonContext().getFilesDir().getParent(), "shared_prefs"));
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && deleteFilesInDir(LingContext.getApplicatonContext().getExternalCacheDir());
    }
