...
import arouter.cuiqiang.com.downloadfilekit.compress.zip.tool.ZipEntry;
...
public class CompressHelper {
    ...
    public static boolean isRARFile(String compressFilePath) {
        return compressFilePath != null && compressFilePath.endsWith(SUFFIX_RAR);
    }

    public static boolean isZIPFile(String compressFilePath) {
